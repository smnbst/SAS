                        ...
                        <!-- PANELS-->
                            ...
                            <div class="panel-body">
                                <div class="example-box-wrapper">
                                    <form class="form-horizontal bordered-row" method="POST" action="{{ route('conditions.store') }}" role="form">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-sm-6">
                                            <input type="text" name ="code" id="code" class="form-control popover-button-default" placeholder="@lang('fields.code')">
                                       </div>
                                   </div>
                                   <div class="form-group">
                                   ...
                                   <div class="form-group">
                                       ...
                                       <div class="col-sm-6">
                                           <input type="text" name ="price" id="price" class="form-control popover-button-default" placeholder="@lang('fields.price')">
                                       </div>
                                   </div>
