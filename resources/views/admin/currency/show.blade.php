...
<div class="panel panel-default">
  ...
  <div class="panel-body">
      <div class="example-box-wrapper">
									<form method="POST" class="form-horizontal bordered-row" action="{{ route('currencies.show', $currency->id) }}"  role="form">
                                 ...
                                 <div class="col-sm-6">
                                     <div class="row">
                                         <div class="col-md-6">
                                             <div class="checkbox checkbox-primary">
                                                 <label>
                                                     <input type="checkbox" id="indicator" name="indicator" disabled="disabled" class="custom-checkbox"></label>
                                             </div>
                                           </div>
									...
									<div class="row">
										...
										<div class="col-xs-2 col-sm-2 col-md-2">
											<a href="{{ route('currencies.index') }}" class="btn btn-info btn-block" >@lang('buttons.back')</a>
										</div>
									</div>
