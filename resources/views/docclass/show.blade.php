                        ...
                        <!-- PANELS-->
                            ...
                            <div class="panel-body">
                                <div class="example-box-wrapper">
                                    <form class="form-horizontal bordered-row" method="POST" action="{{ route('docclasses.update', $docclass->id) }}" role="form">
																				<input name="_method" type="hidden" value="PATCH">
                                    <!--FIELDS-->

                                    <div class="form-group">
                                       <label class="col-sm-3 control-label">@lang('fields.docclass')</label>
                                       <div class="col-sm-6">
                                            <input type="text" name ="docclass" id="docclass" class="form-control popover-button-default" placeholder="@lang('fields.docclass')" value="{{$docclass->docclass}}" disabled="disabled">
                                       </div>
                                   </div>
                                   <div class="form-group">
                                       <label class="col-sm-3 control-label">@lang('fields.description')</label>
                                       <div class="col-sm-6">
                                           <input type="text" name ="description" id="description" class="form-control popover-button-default" placeholder="@lang('fields.docclass')" value="{{$docclass->description}}" disabled="disabled">
                                       </div>
                                   </div>
                                    ...
                                    <!-- -->
                                        ...
                                        <div class="row">
                                            <div class="col-xs-2 col-sm-2 col-md-2">
                                                <a href="{{ route('docclasses.index') }}" class="btn btn-info btn-block">@lang('buttons.back')</a>
                                            </div>
                                        </div>
