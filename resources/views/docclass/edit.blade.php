                            ...
                            <div class="panel-body">
                                <div class="example-box-wrapper">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-sm-6">
                                            <input type="text" name ="docclass" id="docclass" class="form-control popover-button-default" placeholder="@lang('fields.docclass')" value="{{$docclass->docclass}}">
                                       </div>
                                   </div>
                                   <div class="form-group">
                                       <label class="col-sm-3 control-label">@lang('fields.description')</label>
                                       <div class="col-sm-6">
                                           <input type="text" name ="description" id="description" class="form-control popover-button-default" placeholder="@lang('fields.docclass')" value="{{$docclass->description}}">
                                       </div>
                                   </div>
