<div id="page-sidebar">
    <div id="header-logo" class="logo-bg"><a href="{{ url('/') }}" class="logo-content-big" title="DelightUI">SAS <i>UI</i> <span>Student Administration System</span></a> <a href="{{ url('/') }}" class="logo-content-small" title="DelightUI">SAS <i>UI</i> <span>Student Administration System</span></a>
    <a id="close-sidebar" href="#" title="Close sidebar"><i class="glyph-icon icon-outdent"></i></a></div>
    <div class="scroll-sidebar">
        <ul id="sidebar-menu">
            <li class="header"><span>OVERVIEW</span></li>
            <li><a href="{{ url('/') }}" title="Students Administration System"><i class="glyph-icon icon-linecons-tv"></i> <span>Students Administration System</span></a></li>


            <li class="header"><span>@lang('text.students')</span></li>
            <li><a href="javascript:void(0);" title="Elements"><i class="glyph-icon icon-linecons-user"></i> <span>@lang('text.students')</span></a>
                <div class="sidebar-submenu">
                    <ul>
                        <li><a href="buttons.html" title="Buttons"><span>@lang('text.payments')</span></a></li>
                        <li><a href="content-boxes.html" title="Content boxes"><span>@lang('text.search')</span></a></li>
                        <li><a href="labels-badges.html" title="Labels &amp; Badges"><span>@lang('text.subscription')</span></a></li>
                        <li><a href="content-boxes.html" title="Content boxes"><span>@lang('text.reservations')</span></a></li>
                    </ul>
                </div>
            </li>


            <li class="header"><span>@lang('text.secctions')</span></li>
            <li><a href="javascript:void(0);" title="Elements"><i class="glyph-icon icon-linecons-note"></i> <span>@lang('text.secction')</span></a>
                <div class="sidebar-submenu">
                    <ul>
                        <li><a href="buttons.html" title="Buttons"><span>Crear seccion</span></a></li>
                        <li><a href="content-boxes.html" title="Content boxes"><span>Asignar seccion</span></a></li>
                        <li><a href="labels-badges.html" title="Labels &amp; Badges"><span>@lang('text.subscription')</span></a></li>
                        <li><a href="content-boxes.html" title="Content boxes"><span>@lang('text.reservations')</span></a></li>
            ...
            <li class="header"><span>@lang('text.finances')</span></li>
            <li><a href="javascript:void(0);" title="Elements"><i class="glyph-icon icon-linecons-diamond"></i> <span>@lang('text.incoming')</span></a>
                <div class="sidebar-submenu">
                    <ul>
                        <li><a href="buttons.html" title="Buttons"><span>@lang('text.monthlyfees')</span></a></li>
                        <li><a href="labels-badges.html" title="Labels &amp; Badges"><span>@lang('text.subscription')</span></a></li>
            ...
            <li class="header"><span>@lang('text.config')</span></li>
            <li><a href="javascript:void(0);" title="Pages"><i class="glyph-icon icon-linecons-fire"></i> <span>@lang('text.business')</span> <span class="bs-label badge-yellow">NEW</span></a>
                <div class="sidebar-submenu">
                    <ul>
                        <!-- <li><a href="{{ route('currencies.create') }}" title="Alternate dashboard"><span>@lang('text.currencies')</span></a></li> Admin-->
                        <li><a href="{{ route('companies.index') }}" title="View profile"><span>@lang('text.company')</span></a></li>
                        <li><a href="{{ route('employees.index')}}" title="FAQ section"><span>@lang('text.employees')</span></a></li>
                        <li><a href="{{ route('rooms.index') }}" title="Auto menu"><span>@lang('text.rooms')</span></a></li>
                        <li><a href="{{ route('schedules.index')}}" title="Auto menu"><span>@lang('text.schedules')</span></a></li>
                        <li><a href="{{ route('docclasses.index')}}" title="Auto menu"><span>@lang('text.docclass')</span></a></li>
                        <li><a href="{{ route('conditions.index')}}" title="Auto menu"><span>@lang('text.conditions')</span></a></li>


                          <!--<li><a href="{{ route('institutions.create') }}" title="View profile"><span>@lang('text.company')</span></a></li> -->
