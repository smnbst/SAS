                                    ...
                                    <form method="POST" class="form-horizontal bordered-row" action="{{ route('rooms.update', $room->id) }}" role="form">
	                                       <input name="_method" type="hidden" value="PATCH">
		                                    ...
		                                    <div class="form-group">
		                                       ...
		                                       <div class="col-sm-6">
		                                            <input type="text" name ="description" id="description" class="form-control popover-button-default" placeholder="@lang('fields.description')" value="{{$room->description}}">
		                                       </div>
		                                   </div>
																			 ...
																			 <div class="form-group">
																					...
																					<div class="col-sm-6">
																							 <input type="text" name ="dimension" id="dimension" class="form-control popover-button-default" placeholder="@lang('fields.dimension')"value="{{$room->dimension}}">
																					</div>
																			</div>
																			...
																			<div class="form-group">
																				 ...
																				 <div class="col-sm-6">
																							<input type="text" name ="location" id="location" class="form-control popover-button-default" placeholder="@lang('fields.location')" value="{{$room->location}}">
																				 </div>
																		 </div>
																		 ...
																		 <div class="row">
																				 <div class="col-md-6">
																						 <div class="checkbox checkbox-primary">
																								 <label>
                                                    @if($room->air)
                                                     <input type="checkbox" id="air" name="air" class="custom-checkbox"checked="checked">@lang('labels.air')
                                                    @else
																										 <input type="checkbox" id="air" name="air" class="custom-checkbox">@lang('labels.air')
                                                   @endif
                                                   </label>
																						 </div>
