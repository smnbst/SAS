                        ...
                        <!-- PANELS-->
                            ...
                            <div class="panel-body">
                                <div class="example-box-wrapper">
                                    <form class="form-horizontal bordered-row" method="GET" action="{{ route('schedules.update', $schedule->id) }}" role="form">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-sm-6">
                                            <input type="text" name ="days" id="days" class="form-control popover-button-default" disabled="disabled" placeholder="@lang('fields.days')" value="{{$schedule->days}}">
                                       </div>
                                   </div>
                                   <div class="form-group">
                                       <label class="col-sm-3 control-label">@lang('fields.time')</label>
                                       <div class="col-sm-6">
                                           <input type="text" name ="time" id="time" class="form-control popover-button-default" disabled="disabled" placeholder="@lang('fields.time')" value="{{$schedule->time}}">
                                       </div>
                                   </div>
                                    ...
                                    <!-- -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-2 col-sm-2 col-md-2">
                                                <a href="{{ route('schedules.index') }}" class="btn btn-info btn-block">@lang('buttons.back')</a>
                                            </div>
                                        </div>
