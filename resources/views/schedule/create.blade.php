                        ...
                        <!-- PANELS-->
													...
													<div class="panel panel-default" id="screen">
														<div class="panel-heading">
															<h3 class="panel-title">@lang('text.add') @lang('titles.schedule')</h3>
														</div>
                            <div class="panel-body">
                                <div class="example-box-wrapper" >
                                    <!--<form class="form-horizontal bordered-row" action="#" role="form"> -->
                                          ...
                                          <div class="row">
                                             <div class="col-sm-2">
                                                 <div class="bootstrap-timepicker dropdown">
                                                     <input class="timepicker-example form-control" name="time" id="time1" type="text">
                                                 </div>
                                             </div>
                                             <div class="col-sm-2">
                                                 <div class="bootstrap-timepicker dropdown">
                                                     <input class="timepicker-example form-control" name="time" id="time2" type="text">
                                                 </div>
                                             </div>
                                       </div>
                                     </div>
                                    ...
                                    <!-- -->
                                        ...
                                        <div class="row">
                                            <div class="col-xs-2 col-sm-2 col-md-2">
                                                <input type="submit" value="@lang('buttons.save')" class="btn btn-success btn-block " onclick="getData()">
